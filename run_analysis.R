...
## 5. Creates a second independently data sets with the average of each variable for each activity and each subject
...
activity_labels <- read.table("./UCI HAR Dataset/activity_lables.txt") [,2]
